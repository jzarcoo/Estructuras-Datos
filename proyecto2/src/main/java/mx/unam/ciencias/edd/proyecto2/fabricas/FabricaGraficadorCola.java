...
/**
 * <p>Clase para representar una fábrica para crear objetos GraficadorCola.</p>
 */
public class FabricaGraficadorCola extends FabricaGraficadorEstructura {
    ...
    public GraficadorEstructura creaGraficador(Lista<Integer> lista) {
        return new GraficadorCola<Integer>(lista);
    }
}